...
INSERT INTO
  event_relations_new (event_id, person_id, role_id)
SELECT
  event_id,
  person_id,
  role_id
...
INSERT INTO
  event_relation_citations_new (event_relation_id, source_id)
SELECT
  ern.id,
  erc.source_id
FROM
  event_relation_citations erc
  JOIN event_relations_new ern ON ern.event_id = erc.event_id
...
ALTER TABLE event_relations_new
RENAME TO event_relations;

ALTER TABLE event_relation_citations_new
RENAME TO event_relation_citations
