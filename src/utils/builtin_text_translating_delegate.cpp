...
BuiltinTextTranslatingDelegate::BuiltinTextTranslatingDelegate(QObject *parent) :
...
QString
BuiltinTextTranslatingDelegate::displayText(const QVariant &value, const QLocale &locale) const {
