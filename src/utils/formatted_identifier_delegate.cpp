...
FormattedIdentifierDelegate::FormattedIdentifierDelegate(QObject *parent, const QString &pattern) :
    QStyledItemDelegate(parent),
    pattern(pattern) {
}

QString
FormattedIdentifierDelegate::displayText(const QVariant &value, const QLocale &locale) const {
